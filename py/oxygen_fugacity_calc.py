...
# core_eff = 0.88
# output_parent_path = pf.output_parent_default + 'hypatia' + str(int(core_eff * 100)) + 'Fe/'
#
...
# pf.fo2_from_hypatia(p_min, p_max, n_sample=100, T_min=T_min, T_max=T_max, isotherm=T_iso,
