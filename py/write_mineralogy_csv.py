...
def write_from_dir(output_parent_path, write_path, pressures, M_p=1, core_effs=[88], Tp=1600, phase_columns=phase_columns,
                   ox_columns=ox_columns, output_path_override=None, sep=',', test_mode=False,
...
if location == 'apollo':
    ...
    write_from_dir(output_parent_path, '/home/cmg76/Works/rocky-water/csv/',
                   fname_base='mantle_compositions',
